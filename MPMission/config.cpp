...
class CfgMine
{
	...
	class types
	{
		...
		*/
		...
		class rhs_ec200_sand_mag: DefaultMine  						{ CfgVehicleName = "rhs_magazine_rhs_ec200_mag"; isRemote = true; };
		class rhs_ec400_sand_mag: DefaultMine  						{ CfgVehicleName = "rhs_magazine_rhs_ec400_mag"; isRemote = true; };
		...
		class SatchelCharge_Remote_Mag: DefaultMine  				{ CfgVehicleName = "SatchelCharge_F"; isRemote = true; };
